...
const linkClass = ({ isActive }) =>
  `relative flex items-center gap-3 px-3 py-2.5 text-sm transition-colors duration-200 group ${
    isActive
        ...
        {NAV.map((n) => {
          ...
          return (
            <NavLink
              ...
              className={linkClass}
            >
              <Icon className="w-4 h-4 shrink-0 transition-transform duration-200 group-hover:scale-110" strokeWidth={2} />
        ...
        {user?.role === "super_admin" && (
          <>
            ...
            <NavLink
              ...
              className={linkClass}
            >
              <Shield className="w-4 h-4 shrink-0 transition-transform duration-200 group-hover:scale-110" strokeWidth={2} />
