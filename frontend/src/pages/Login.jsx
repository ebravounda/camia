...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#090A0F] text-white px-4" data-testid="login-page">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#12141D] border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-gray-400 mt-1">Bienvenido de vuelta a tu centro de control.</p>
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-[#090A0F] border-white/10 focus-visible:ring-blue-500 h-11"
              />
            </div>
            <div className="space-y-2">
            ...
            {error && (
              <div data-testid="login-error" className="text-sm text-red-400 bg-red-500/10 border border-red-500/20 rounded-md px-3 py-2">
                {error}
              </div>
            )}
          ...
          <p className="mt-6 text-sm text-gray-400 text-center">
            ¿No tienes cuenta?{" "}
            <Link to="/register" className="text-blue-400 hover:text-blue-300 font-medium" data-testid="login-register-link">
              Crear cuenta
            </Link>
          </p>
        </div>
